...
> Historical design proposal. This file documents the original rollout plan and terminology.
> For current behavior and supported interfaces, use `README.md` and `docs/index.md`.
